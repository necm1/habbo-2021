package com.sulake.habbo.room.object.visualization.avatar.additions
{
    ...
    public class TypingBubble implements IAvatarAddition 
    {
        ...
        public function update(_arg_1:IRoomObjectSprite, _arg_2:Number):void
        {
            ...
            if (_arg_2 < 48)
            {
                _asset = (_SafeStr_1265.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset);
                _local_3 = 3;
                _local_4 = -42;
                _local_5 = 32;
            }
            ...
            {
                _asset = (_SafeStr_1265.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset);
                _local_3 = 14;
                _local_4 = -83;
            };
