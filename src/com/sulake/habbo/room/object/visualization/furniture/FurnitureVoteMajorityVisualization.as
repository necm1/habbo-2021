package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurnitureVoteMajorityVisualization extends AnimatedFurnitureVisualization 
    {
        ...
        private static const _SafeStr_3391:int = -1;
        ...
        override protected function getFrameNumber(_arg_1:int, _arg_2:int):int
        {
            ...
            var _local_5:int = _local_4.getNumber("furniture_vote_majority_result");
        ...
        override protected function getSpriteAlpha(_arg_1:int, _arg_2:int, _arg_3:int):int
        {
            ...
            var _local_6:int = _local_5.getNumber("furniture_vote_majority_result");
            if (((!(HIDE_RESULTS_STATES.indexOf(object.getState(0)) == -1)) || (_local_6 == -1)))
            {
