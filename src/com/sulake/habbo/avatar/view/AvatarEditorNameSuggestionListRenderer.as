package com.sulake.habbo.avatar.view
{
    ...
    public class AvatarEditorNameSuggestionListRenderer 
    {
        ...
        {
            var _local_2:ITextWindow = (_SafeStr_825.windowManager.buildFromXML(XML(HabboAvatarEditorCom.avatar_editor_name_change_item)) as ITextWindow);
            if (_local_2 == null)
            {
                return (null);
            };
