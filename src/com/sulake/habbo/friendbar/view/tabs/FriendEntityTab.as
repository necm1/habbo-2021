package com.sulake.habbo.friendbar.view.tabs
{
    ...
    public class FriendEntityTab extends Tab 
    {
        ...
        private static const _SafeStr_2408:String = "entity_xml";
        ...
        private static const _SafeStr_1036:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
        ...
        {
            var _local_2:FriendEntityTab = ((_SafeStr_1036.length > 0) ? _SafeStr_1036.pop() : new FriendEntityTab());
        ...
        override public function select(_arg_1:Boolean):void
        {
            ...
            if (!selected)
            {
                ...
                if (friend.online)
                {
                    _local_6 = (WINDOWING.buildFromXML((ASSETS.getAssetByName("controls_piece_xml").content as XML)) as IWindowContainer);
        ...
        {
            var _local_1:IWindowContainer = ((_SafeStr_2414.length > 0) ? _SafeStr_2414.pop() : (WINDOWING.buildFromXML((ASSETS.getAssetByName("entity_xml").content as XML)) as IWindowContainer));
        ...
        private function showBubble():void
        {
            ...
            if (_window)
            {
                ...
                _window.findChildByName("bubble_message").caption = _SafeStr_624.getLocalization((("gamecenter." + _SafeStr_2417) + ".name"));
