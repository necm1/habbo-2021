package com.sulake.habbo.communication.messages.incoming.catalog
{
        ...
        public class LimitedOfferAppearingNextMessageEvent extends MessageEvent implements IMessageEvent 
    {
        ...
        public function LimitedOfferAppearingNextMessageEvent(_arg_1:Function)
        {
            super(_arg_1, LimitedOfferAppearingNextMessageParser);
        }

        public function getParser():LimitedOfferAppearingNextMessageParser
        {
            return (this._SafeStr_816 as LimitedOfferAppearingNextMessageParser);
        }
