package com.sulake.habbo.communication.messages.incoming.catalog
{
        ...
        public class SellablePetPalettesMessageEvent extends MessageEvent implements IMessageEvent 
    {
        ...
        public function SellablePetPalettesMessageEvent(_arg_1:Function)
        {
            super(_arg_1, SellablePetPalettesParser);
        }

        public function getParser():SellablePetPalettesParser
        {
            return (this._SafeStr_816 as SellablePetPalettesParser);
        }
