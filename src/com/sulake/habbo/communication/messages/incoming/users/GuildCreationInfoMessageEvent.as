package com.sulake.habbo.communication.messages.incoming.users
{
        ...
        public class GuildCreationInfoMessageEvent extends MessageEvent implements IMessageEvent 
    {
        ...
        public function GuildCreationInfoMessageEvent(_arg_1:Function)
        {
            super(_arg_1, GuildCreationInfoMessageParser);
        }

        public function get data():GuildCreationData
        {
            return (GuildCreationInfoMessageParser(_SafeStr_816).data);
        }
