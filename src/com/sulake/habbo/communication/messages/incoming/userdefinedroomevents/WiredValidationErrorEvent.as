package com.sulake.habbo.communication.messages.incoming.userdefinedroomevents
{
        ...
        public class WiredValidationErrorEvent extends MessageEvent implements IMessageEvent 
    {
        ...
        public function WiredValidationErrorEvent(_arg_1:Function)
        {
            super(_arg_1, WiredValidationErrorParser);
        }

        public function getParser():WiredValidationErrorParser
        {
            return (this._SafeStr_816 as WiredValidationErrorParser);
        }
