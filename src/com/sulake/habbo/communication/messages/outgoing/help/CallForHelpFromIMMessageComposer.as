package com.sulake.habbo.communication.messages.outgoing.help
{
        ...
        public class CallForHelpFromIMMessageComposer implements IMessageComposer, IDisposable 
    {
        ...
        public function CallForHelpFromIMMessageComposer(_arg_1:String, _arg_2:int, _arg_3:int, _arg_4:Array)
        {
            this._SafeStr_875.push(_arg_1);
            this._SafeStr_875.push(_arg_2);
            this._SafeStr_875.push(_arg_3);
            this._SafeStr_875.push((_arg_4.length / 2));
            this._SafeStr_875 = this._SafeStr_875.concat(_arg_4);
        }
