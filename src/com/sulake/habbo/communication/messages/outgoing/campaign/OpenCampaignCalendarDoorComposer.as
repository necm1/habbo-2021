package com.sulake.habbo.communication.messages.outgoing.campaign
{
    ...
    import com.sulake.core.runtime.IDisposable;
        ...
        public class OpenCampaignCalendarDoorComposer implements IMessageComposer, IDisposable 
    {

        private var _SafeStr_875:Array = [];

        public function OpenCampaignCalendarDoorComposer(_arg_1:String, _arg_2:int)
        {
