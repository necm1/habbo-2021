package com.sulake.habbo.moderation
{
    ...
    public class MyIssuesView implements IIssueBrowserView 
    {
        ...
        public function MyIssuesView(_arg_1:IssueManager, _arg_2:IssueBrowser, _arg_3:IWindowContainer)
        {
            ...
            _view = _arg_3;
            _view.visible = false;
            var _local_5:IItemListWindow = (_view.findChildByName("issue_list") as IItemListWindow);
            _SafeStr_2871 = new IssueListView(_arg_1, _arg_2, _local_5);
            var _local_4:IWindow = _view.findChildByName("release_all");
            if (_local_4 != null)
            {
        ...
        {
            var _local_1:Array = _SafeStr_2848.getBundles("issue_bundle_my");
