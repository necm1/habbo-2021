package com.sulake.habbo.toolbar.extensions.settings
{
    ...
    public class SoundSettingsItem implements IDisposable 
    {
        ...
        private var _SafeStr_3782:SoundSettingsView;

        public function SoundSettingsItem(_arg_1:SoundSettingsView, _arg_2:int, _arg_3:IWindowContainer):void
        {
            super();
            ...
            _window = _arg_3;
            _SafeStr_3664 = new MeMenuSoundSettingsSlider(this, (_window.findChildByName("volume_container") as IWindowContainer), _arg_1.toolbar.assets, 0, 1);
