package com.sulake.habbo.toolbar.memenu
{
    ...
    public class MeMenuNewIconLoader implements IAvatarImageListener 
    {
        ...
        private var _SafeStr_3803:FigureUpdateEvent;

        public function MeMenuNewIconLoader(_arg_1:HabboToolbar)
        {
            _toolbar = _arg_1;
            _SafeStr_2351 = new UserObjectEvent(onUserObject);
            _SafeStr_3803 = new FigureUpdateEvent(onFigureUpdate);
            _toolbar.communicationManager.addHabboConnectionMessageEvent(_SafeStr_2351);
            _toolbar.communicationManager.addHabboConnectionMessageEvent(_SafeStr_3803);
        ...
        private function onFigureUpdate(_arg_1:FigureUpdateEvent):void
        {
            if (disposed)
            {
                return;
        ...
        public function dispose():void
        {
            ...
            {
                _toolbar.communicationManager.removeHabboConnectionMessageEvent(_SafeStr_3803);
                _SafeStr_3803 = null;
            };
            _toolbar = null;
        }
