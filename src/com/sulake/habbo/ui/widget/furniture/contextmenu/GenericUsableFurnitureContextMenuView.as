package com.sulake.habbo.ui.widget.furniture.contextmenu
{
    ...
    public class GenericUsableFurnitureContextMenuView extends FurnitureContextInfoView 
    {
        ...
        public function GenericUsableFurnitureContextMenuView(_arg_1:IContextMenuParentWidget)
        {
            super(_arg_1);
        }
        ...
        override protected function updateWindow():void
        {
            ...
            else
            {
                if (!_window)
                {
                    _local_1 = (XmlAsset(_SafeStr_1324.assets.getAssetByName("generic_usable_menu")).content as XML);
