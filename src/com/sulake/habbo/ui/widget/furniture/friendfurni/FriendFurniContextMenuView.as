package com.sulake.habbo.ui.widget.furniture.friendfurni
{
    ...
    public class FriendFurniContextMenuView extends FurnitureContextInfoView 
    {
        ...
        public function FriendFurniContextMenuView(_arg_1:IContextMenuParentWidget)
        {
            super(_arg_1);
        }
        ...
        override protected function updateWindow():void
        {
            ...
            else
            {
                ...
                {
                    _local_1 = (_SafeStr_1324.assets.getAssetByName("friendfurni_menu").content as XML);
                ...
                if (_arg_2.name == "button")
                {
                    switch (_arg_2.parent.name)
                    {
                        case "use":
                            ...
                            if (_local_4 != null)
                            {
                                _local_4.handler.container.connection.send(new UseFurnitureMessageComposer(_SafeStr_4065.getId()));
                            };
                    };
                };
                _local_3 = true;
