package com.sulake.habbo.ui.widget.avatarinfo
{
    ...
    public class AvatarContextInfoButtonView extends ButtonMenuView 
    {
        ...
        public function AvatarContextInfoButtonView(_arg_1:IContextMenuParentWidget)
        {
            super(_arg_1);
        }

        public static function setup(_arg_1:AvatarContextInfoButtonView, _arg_2:int, _arg_3:String, _arg_4:int, _arg_5:int, _arg_6:Boolean=false, _arg_7:Boolean=false):void
        {
        ...
        override protected function getOffset(_arg_1:Rectangle):int
        {
            ...
            if ((((_SafeStr_3881 == 1) || (_SafeStr_3881 == 3)) || (_SafeStr_3881 == 4)))
            {
