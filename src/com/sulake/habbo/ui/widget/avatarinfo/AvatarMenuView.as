    ...
    public class AvatarMenuView extends AvatarContextInfoButtonView 
    {
        ...
        protected function updateButtons():void
        {
            ...
            if (_SafeStr_1493 == 1)
            {
                ...
                _local_10 = _SafeStr_690.respectLeft;
                this.widget.localizations.registerParameter("infostand.button.respect", "count", _local_10.toString());
                showButton("respect", (_local_10 > 0));
                ...
                if (_arg_2.name == "button")
                {
                    ...
                    switch (_arg_2.parent.name)
                    {
                        ...
                        case "stargem":
                            ...
                            break;
                        case "respect":
                            _SafeStr_690.respectLeft--;
                            _local_6 = _SafeStr_690.respectLeft;
                            this.widget.localizations.registerParameter("infostand.button.respect", "count", _local_6.toString());
                            showButton("respect", (_SafeStr_690.respectLeft > 0));
                            _local_5 = RoomWidgetUserActionMessage.RESPECT_USER;
                            if (_local_6 > 0)
                            {
                                _local_3 = false;
                            }
