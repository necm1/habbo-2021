package com.sulake.habbo.game.snowwar.leaderboard
{
    ...
    public class WeeklyFriendLeaderboardTable extends LeaderboardTable 
    {
        ...
        public function WeeklyFriendLeaderboardTable(_arg_1:SnowWarEngine)
        {
            super(_arg_1);
        }
        ...
        {
            return (new Game2GetWeeklyFriendsLeaderboardComposer(_arg_1, _offset, _arg_2, _arg_3, _SafeStr_2518, _SafeStr_2519));
        }
