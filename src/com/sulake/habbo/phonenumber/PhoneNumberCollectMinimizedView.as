package com.sulake.habbo.phonenumber
{
    ...
    public class PhoneNumberCollectMinimizedView 
    {
        ...
        private function createWindow():void
        {
            ...
            _window = _SafeStr_659.windowManager.buildFromXML(XML(_SafeStr_659.assets.getAssetByName("phonenumber_collect_minimized_xml").content));
        ...
        {
            _SafeStr_659.setCollectViewMinimized(false);
        }
